		...
		<div class="header-bottom">
			<div class="logo text-center">
				<a href="index.html"><img
					src="${ctx}/static/lib/images/logo.jpg" alt="" /></a>
			</div>
					...
					<div class="wrap">
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav">
								...
								<c:forEach items="${categories}" var="cd">
									<c:choose>
										<c:when test="${cd.children.size() > 0}">
											<li class="dropdown"><a href="#" class="dropdown-toggle"
												data-toggle="dropdown">${cd.name }<b class="caret"></b></a>
												<ul class="dropdown-menu">
													<c:set value="${cd.children}" var="children"></c:set>
													<c:forEach var="cc" items="${children}" varStatus="step">
														<li><a href="entertainment.html">${cc.name}</a></li>
														<c:set value="${cd.children.size() }" var="num"></c:set>
														<li class="divider"></li>
													</c:forEach>
												</ul></li>
										</c:when>
										<c:otherwise>
											<li><a href="sports.html">${cd.name}</a></li>
										</c:otherwise>
									</c:choose>
								</c:forEach>
		...
		<div class="move-text">
			...
			<div class="marquee">
				<c:forEach items="${articles }" var="art">
					<div class="marquee1" style="margin-right: 50px;">
			...
			<div class="col-md-8 content-left">
					...
					<div class="callbacks_wrap">
						<ul class="rslides" id="slider">
							<c:forEach items="${ads}" var="ad">
								<li>
									<img style="height: 300px;" src="${server}/${ad.attachment.path}" alt="">
									<div class="caption">
										<a href="${ad.url}">
											${ad.title }
										</a>
				...
				<div class="articles">
					...
					<div class="article">
						<div class="article-left">
							<a href="single.html"><img
								src="${ctx}/static/lib/images/article1.jpg"></a>
						</div>
						<div class="article-right">
							...
							<div class="article-text">
								...
								<a href="single.html"><img
									src="${ctx}/static/lib/images/more.png" alt="" /></a>
								<div class="clearfix"></div>
							</div>
						</div>
						<div class="clearfix"></div>
					...
					<div class="article">
						<div class="article-left">
							<a href="single.html"><img
								src="${ctx}/static/lib/images/article3.jpg"></a>
						</div>
						<div class="article-right">
							<div class="article-title">
								<p>
					...
					<div class="article">
						<div class="article-left">
							<a href="single.html"><img
								src="${ctx}/static/lib/images/article4.jpg"></a>
						</div>
						<div class="article-right">
							<div class="article-title">
								<p>
				...
				<div class="life-style">
					...
					<div class="life-style-grids">
						<div class="life-style-left-grid">
							<a href="single.html"><img
								src="${ctx}/static/lib/images/l1.jpg" alt="" /></a> <a
						...
						<div class="life-style-right-grid">
							<a href="single.html"><img
								src="${ctx}/static/lib/images/l2.jpg" alt="" /></a> <a
					...
					<div class="life-style-grids">
						<div class="life-style-left-grid">
							<a href="single.html">
								<img src="${ctx}/static/lib/images/l3.jpg" alt="" />
							</a> 
						...
						<div class="life-style-right-grid">
							<a href="single.html">
								<img src="${ctx}/static/lib/images/l4.jpg" alt="" />
							</a> 
							<a class="title" href="single.html">
					...
					<div class="s-grid-left">
						<div class="cricket">
							...
							<div class="c-sports-main">
								<div class="c-image">
									<a href="single.html"><img
										src="${ctx}/static/lib/images/bus1.jpg" alt="" /></a>
								</div>
								<div class="c-text">
									<h6>Lorem Ipsum</h6>
							...
							<div class="s-grid-small">
								<div class="sc-image">
									<a href="single.html"><img
										src="${ctx}/static/lib/images/bus2.jpg" alt="" /></a>
								</div>
								<div class="sc-text">
									<h6>Lorem Ipsum</h6>
									<a class="power" href="single.html">It is a long
							...
							<div class="s-grid-small">
								<div class="sc-image">
									<a href="single.html"><img
										src="${ctx}/static/lib/images/bus3.jpg" alt="" /></a>
								</div>
								<div class="sc-text">
									<h6>Lorem Ipsum</h6>
									<a class="power" href="single.html">It is a long
							...
							<div class="s-grid-small">
								<div class="sc-image">
									<a href="single.html"><img
										src="${ctx}/static/lib/images/bus4.jpg" alt="" /></a>
								</div>
								<div class="sc-text">
									<h6>Lorem Ipsum</h6>
									<a class="power" href="single.html">It is a long
					...
					<div class="s-grid-right">
						<div class="cricket">
							...
							<div class="c-sports-main">
								<div class="c-image">
									<a href="single.html"><img
										src="${ctx}/static/lib/images/tec1.jpg" alt="" /></a>
								</div>
								<div class="c-text">
									<h6>Lorem Ipsum</h6>
									<a class="power" href="single.html">It is a long
							...
							<div class="s-grid-small">
								<div class="sc-image">
									<a href="single.html"><img
										src="${ctx}/static/lib/images/tec2.jpg" alt="" /></a>
								</div>
								<div class="sc-text">
									<h6>Lorem Ipsum</h6>
									<a class="power" href="single.html">It is a long
							...
							<div class="s-grid-small">
								<div class="sc-image">
									<a href="single.html"><img
										src="${ctx}/static/lib/images/tec3.jpg" alt="" /></a>
								</div>
								<div class="sc-text">
									<h6>Lorem Ipsum</h6>
									<a class="power" href="single.html">It is a long
									...
									<a class="reu" href="single.html">
										<img src="${ctx}/static/lib/images/more.png" alt="" />
									</a>
									<div class="clearfix"></div>
								</div>
								<div class="clearfix"></div>
							...
							<div class="s-grid-small">
								<div class="sc-image">
									<a href="single.html"><img
										src="${ctx}/static/lib/images/tec4.jpg" alt="" /></a>
								</div>
								<div class="sc-text">
									<h6>Lorem Ipsum</h6>
				...
				<div class="first_half">
						...
						<section class="accordation_menu">
							<div>
								<input id="label-1" name="lida" type="radio" checked /> <label
									for="label-1" id="item1"><i class="ferme"> </i>热门职位<i
							...
							<div>
								<input id="label-2" name="lida" type="radio" /> <label
									for="label-2" id="item2"><i class="icon-leaf" id="i2"></i>最近的帖子<i
									class="icon-plus-sign i-right1"></i><i
									class="icon-minus-sign i-right2"></i></label>
							...
							<div>
								<input id="label-3" name="lida" type="radio" /> <label
									for="label-3" id="item3"><i class="icon-trophy" id="i3"></i>评论<i
									class="icon-plus-sign i-right1"></i><i
									class="icon-minus-sign i-right2"></i></label>
												...
												<div class="media response-info">
													<div class="media-left response-text-left">
														<a href="#"> <img class="media-object"
															src="${ctx}/static/lib/images/icon1.png" alt="" />
														</a>
														<h5>
															<a href="#">Username</a>
														</h5>
					...
					<div class="side-bar-articles">
						<div class="side-bar-article">
							<a href="single.html"><img
								src="${ctx}/static/lib/images/sai.jpg" alt="" /></a>
						...
						<div class="side-bar-article">
							<a href="single.html"><img
								src="${ctx}/static/lib/images/sai2.jpg" alt="" /></a>
							<div class="side-bar-article-title">
						...
						<div class="side-bar-article">
							<a href="single.html"><img
								src="${ctx}/static/lib/images/sai3.jpg" alt="" /></a>
							<div class="side-bar-article-title">
					...
					<div class="popular-news">
						...
						<div class="popular-grids">
							<div class="popular-grid">
								<a href="single.html"><img
									src="${ctx}/static/lib/images/popular-4.jpg" alt="" /></a> <a
									class="title" href="single.html">It is a long established
									fact that a reader will be distracted</a>
								<p>
							...
							<div class="popular-grid">
								<a href="single.html"><img
									src="${ctx}/static/lib/images/popular-1.jpg" alt="" /></a> <a
									class="title" href="single.html">It is a long established
									fact that a reader will be distracted</a>
								<p>
							...
							<div class="popular-grid">
								<a href="single.html"><img
									src="${ctx}/static/lib/images/popular-3.jpg" alt="" /></a> <a
									class="title" href="single.html">It is a long established
									fact that a reader will be distracted</a>
								<p>
									On Mar 14, 2015 <a class="span_link" href="#"><span
