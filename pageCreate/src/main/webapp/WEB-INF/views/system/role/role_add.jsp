        ...
        <form class="form form-horizontal" id="form-article-add" method="post" action="">
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-10">
                    <input type="text" onclick="showTree()" value="${role.role.roleName}" class="input-text" value="" readonly="readonly" placeholder="请选择上级菜单" id="pName"
                           name="pName">
                    <input type="hidden" class="input-text" value="${role.role.id}" placeholder="" id="pId" name="pId">
                    <input type="hidden" value="${role.id}" placeholder="" id="id" name="id">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-10">
                    <input type="text" class="input-text" value="${role.roleDesc}" placeholder="请输入角色描述信息" id="roleDesc" name="roleDesc">
                </div>
            </div>
