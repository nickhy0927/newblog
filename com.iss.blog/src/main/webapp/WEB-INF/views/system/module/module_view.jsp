        ...
        <form class="form form-horizontal" id="form-article-add">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-10">
                    <input type="text" class="input-text" value="${module.module.name}"
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-10">
                    <input type="text" class="input-text" readonly="readonly" value="${module.name}" placeholder="请输入菜单名称" id="name"
                           name="name">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-10">
                    <input readonly="readonly" type="text" class="input-text" value="${module.url}" placeholder="请输入菜单地址" id="url"
                           name="url">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-10">
                    <input type="text" class="input-text" readonly="readonly" value="${module.alias}" placeholder="请输入菜单地址" id="alias"
                           name="alias">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-10">
                    <input type="text" class="input-text" readonly="readonly" value="${module.descs}" placeholder="请输入菜单描述信息" id="descs"
                           name="descs">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-10 skin-minimal">
                    <c:if test="${module.shows != '' && module.shows != null}">
                        <div class="radio-box">
                            <input name="shows" value="0" type="radio" readonly="readonly"
                                   <c:if test="${module.shows == '0'}">checked="checked"</c:if> id="sex-1">
                            <label for="sex-1">不显示</label>
                        </div>
                        <div class="radio-box">
                            <input type="radio" value="1" id="sex-2" readonly="readonly"
