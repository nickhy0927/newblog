...
CREATE TABLE IF NOT EXISTS `t_c_article` (
  ...
  CONSTRAINT `FK_oi095swawmh241css0lsdx7f3` FOREIGN KEY (`user_id`) REFERENCES `t_p_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  blog.t_c_article 的数据：~12 rows (大约)
...
-- 正在导出表  blog.t_c_category 的数据：~6 rows (大约)
...
CREATE TABLE IF NOT EXISTS `t_c_comment` (
  ...
  CONSTRAINT `FK_cuyy9xsb30rmwp0kg2yx5usl6` FOREIGN KEY (`user_id`) REFERENCES `t_p_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `t_c_praise` (
  ...
  CONSTRAINT `FK_iv87ppxvgv8l1xpw7qq56cg7q` FOREIGN KEY (`user_id`) REFERENCES `t_p_user` (`id`),
...
-- 正在导出表  blog.t_p_module 的数据：~20 rows (大约)
...
INSERT INTO `t_p_module` (`id`, `create_time`, `disabled`, `update_time`, `name`, `url`, `pid`, `descs`, `alias`, `shows`, `icon_id`) VALUES
	...
	('1cd17747-5bd3-4cba-a4ef-4315dce77af8', '2017-08-01 15:42:02', b'0', '2017-08-08 13:50:14', '用户角色列表', '/platform/user/role/list', '007a27e3-d5cd-436e-a2da-ce58e8a09db8', '用户所对应的角色', 'userRole-manager', '1', 'e6b58065-a6ca-41d1-906c-5f19917256a9'),
	...
	('495c99b8-62b7-4d30-ac5e-7716adf64c0c', '2017-07-28 16:20:55', b'0', '2017-08-08 13:50:34', '用户列表', '/platform/user/list', '007a27e3-d5cd-436e-a2da-ce58e8a09db8', '管理所有的用户信息', 'user-manager', '1', 'e6b58065-a6ca-41d1-906c-5f19917256a9'),
	...
	('56688a3d-fda3-41b1-90db-2af1957e249c', '2017-07-28 16:14:39', b'0', '2017-08-08 13:51:02', '菜单列表', '/platform/module/list', '007a27e3-d5cd-436e-a2da-ce58e8a09db8', '管理所有的菜单信息', 'module-manager', '1', 'e6b58065-a6ca-41d1-906c-5f19917256a9'),
	...
	('60f738ac-16c5-4507-bb33-a4455740b760', '2017-08-01 17:02:31', b'0', '2017-08-08 13:49:57', '图标列表', '/platform/icon/list', '007a27e3-d5cd-436e-a2da-ce58e8a09db8', '菜单旁边的图标', 'icon-manager', '1', 'e6b58065-a6ca-41d1-906c-5f19917256a9'),
	...
	('be6debfe-a075-416f-ad9d-d53785c86520', '2017-07-28 16:16:19', b'0', '2017-08-08 13:50:49', '角色列表', '/platform/role/list', '007a27e3-d5cd-436e-a2da-ce58e8a09db8', '管理所有的角色信息', 'role-manager', '1', 'e6b58065-a6ca-41d1-906c-5f19917256a9'),
...
-- 导出  表 blog.t_p_picture 结构
DROP TABLE IF EXISTS `t_p_picture`;
CREATE TABLE IF NOT EXISTS `t_p_picture` (
  `id` varchar(255) NOT NULL,
  `create_time` datetime DEFAULT NULL,
  `disabled` bit(1) DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
...
-- 正在导出表  blog.t_p_picture 的数据：~0 rows (大约)
DELETE FROM `t_p_picture`;
/*!40000 ALTER TABLE `t_p_picture` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_p_picture` ENABLE KEYS */;
...
INSERT INTO `t_p_role` (`id`, `create_time`, `disabled`, `update_time`, `role_desc`, `role_name`, `pid`) VALUES
	...
	('c15cc5a0-4e67-493a-864f-21a007d6b2ad', '2017-07-31 16:12:47', b'0', '2017-08-07 17:20:19', '管理员角色', '管理员', '1'),
...
-- 正在导出表  blog.t_p_role_module 的数据：~17 rows (大约)
DELETE FROM `t_p_role_module`;
/*!40000 ALTER TABLE `t_p_role_module` DISABLE KEYS */;
INSERT INTO `t_p_role_module` (`role_id`, `module_id`) VALUES
...
-- 正在导出表  blog.t_p_user_role 的数据：~5 rows (大约)
