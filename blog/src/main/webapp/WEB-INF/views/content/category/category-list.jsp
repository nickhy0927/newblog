...
<pgs:extends name="body">
    <form action="${ctx}/content/category/list" method="post" id="queryForm" name="queryForm">
            ...
            <div class="text-l">
                <table class="search-table">
                    <tr>
                        ...
                        <td colspan="3">
                            <input type="text" value="${objectMap.name_li}" id="name_li" name="name_li"
                                   placeholder="菜单名称" class="input-text" style="width:260px;">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
    ...
    <script type="text/javascript">
        ...
        /*资讯-添加*/
        function module_add() {
            var title = '添加分类', url = '${ctx}/content/category/add', w = 600, h = 500;
