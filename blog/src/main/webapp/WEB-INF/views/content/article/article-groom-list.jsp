...
<pgs:extends name="javascript">
    ...
    <script type="text/javascript">
        ...
        function article_shenhe(id) {
        	if(confirm('确认要推荐吗？')) {
        		submitGroom(layer,id,1)
        	}
        }

        function submitGroom(layer, id, groom) {
            var url = '${ctx}/content/article/groom/approval'
            openLoading();
            $.ajax({
                url: url,
                type: 'post',
                dataType: 'JSON',
                data: {id: id, groom: groom},
                success: function (data) {
                    closeLoading();
                    alert('推荐成功')
                    window.location.href = "${ctx}/content/article/groom/list"
